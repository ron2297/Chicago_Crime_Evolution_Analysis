...
```{r}
library(dbscan)
dbscan::kNNdistplot(crossdist(crimePPP_Assault[1:10000],crimePPP_Theft[1:10000]), k =  4)
abline(h = 0.4, lty = 2)
```
...
# dbscan package
res.db <- dbscan::dbscan(crossdist(crimePPP_Assault[1:10000],crimePPP_Theft[1:10000]), 0.4, 4)
...
res.db <- dbscan::dbscan(crossdist(crimePPP_Assault[1:5000],crimePPP_Theft[1:5000]), 0.4, 4)
tesing_Shit<-fviz_cluster(res.db, crossdist(crimePPP_Assault[1:5000],crimePPP_Theft[1:5000]), geom = "point")
tesing_Shit
end_time <- Sys.time()
