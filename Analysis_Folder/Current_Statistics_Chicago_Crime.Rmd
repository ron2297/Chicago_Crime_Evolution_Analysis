...
```{r}
library(dbscan)
dbscan::kNNdistplot(crossdist(crimePPP_Assault[1:10000],crimePPP_Assault[1:10000]), k =  4)
abline(h = 0.25, lty = 2)
...
DBSCAN_Cluster_Plots <- function(crime_type_dist){
  ...
  res.db <- dbscan::dbscan(crossdist(crime_type_dist[1:5000],crime_type_dist[1:5000]), 0.4, 4)
  
  tesing_Shit<-fviz_cluster(res.db, crossdist(crime_type_dist[1:5000],crime_type_dist[1:5000]), 
...
DBSCAN_Cluster_Plots(crimePPP_Theft)
DBSCAN_Cluster_Plots(crimePPP_Battery)
DBSCAN_Cluster_Plots(crimePPP_Damage)
DBSCAN_Cluster_Plots(crimePPP_Assault)
